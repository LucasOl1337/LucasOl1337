...
- **Full-stack SaaS** — multi-tenant architecture (80+ tenant-scoped relations), RBAC, payments (PIX/boleto), e-signature, and mobile PWA.
...
- **The Last Arrow** — a PvP game in Unity / C#, my sandbox for real-time gameplay and AI playtesting experiments.
